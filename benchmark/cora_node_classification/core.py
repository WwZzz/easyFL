...
class TaskGen(BasicTaskGen):
    def __init__(self, dist_id, num_clients = 1, skewness = 0.5, local_hld_rate=0.2, seed=0):
        super(TaskGen, self).__init__(benchmark='cora_node_classification',
                                      dist_id=dist_id,
                                      skewness=skewness,
                                      rawdata_path='./benchmark/RAW_DATA/CORA',
    ...
    def load_data(self):
        self.all_data = Planetoid(root=self.rawdata_path, name='Cora')
